...
void initialViewTest() {
  group("Initial View Test", () {
    testWidgets('아이템이 25개일때 1부터 5까지 텍스트 버튼이 존재하는가',
    ...
    testWidgets('아이템이 21개일때 1부터 5까지 텍스트 버튼이 존재하는가',
        (WidgetTester tester) async {
      //Given + When
      await tester.pumpWidgetWithMaterialApp(PagenationWidget(
        totalItemCount: 21,
    ...
    testWidgets('아이템이 20개일때 1부터 4까지 텍스트 버튼이 존재하는가',
        (WidgetTester tester) async {
      //Given + When
      await tester.pumpWidgetWithMaterialApp(PagenationWidget(
        totalItemCount: 20,
...
void initialStateTest() {
  group("Initial State Test", () {
    testWidgets('아이템이 25개일때 State의 totalPageCount는 5이다.',
        (WidgetTester tester) async {
      //Given + When
      await tester.pumpWidgetWithMaterialApp(PagenationWidget(
        key: Key("pagenation"),
      ...
      final pageState =
          tester.state<PagenationWidgetState>(find.byKey(Key("pagenation")));

      // Then
      expect(pageState.totalPageCount, 5);
    });

    testWidgets('아이템이 21개일때 State의 totalPageCount는 5이다.',
        (WidgetTester tester) async {
      //Given + When
      await tester.pumpWidgetWithMaterialApp(PagenationWidget(
        key: Key("pagenation"),
    ...
    testWidgets('아이템이 20개일때 State의 totalPageCount는 4이다.',
        (WidgetTester tester) async {
      //Given + When
      await tester.pumpWidgetWithMaterialApp(PagenationWidget(
        key: Key("pagenation"),
...
void interactionTest() {
  group("Interaction Test", () {
    testWidgets('아이템이 26개일때 오른쪽 화살표를 누르면 6이 보이고, 7은 안보이는가',
        (WidgetTester tester) async {
      // Build the widget.
      await tester.pumpWidget(MaterialApp(
          home: Material(
